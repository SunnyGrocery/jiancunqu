package edu.sust.jiancunqu.obs;
...
public class GetTokenSample {
	...
	private static void getToken() {
		...
		/*
		 * request body sample { "auth": { "identity": { "methods":
		 * ["password"], "password": { "user": { "name": "***userName***",
		 * "password": "***passWord***", "domain": { "name": "***domainName***"
	...
	private static void getSecurityToken(String token) {
		...
		/*
		 * request body sample { "auth": { "identity": { "methods": [ "token" ],
		 * "token": { "id": "***yourToken***", "duration-seconds":
		 * "***your-duration-seconds***" } } } }
		 */
		String content = "{\r\n" + "    \"auth\": {\r\n" + "        \"identity\": {\r\n"
				+ "            \"methods\": [\r\n" + "                \"token\"\r\n" + "            ],\r\n"
				+ "            \"token\": {\r\n" + "                \"id\": \"" + token + "\",\r\n"
